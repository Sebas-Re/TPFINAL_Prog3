    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2">PC - BOOSTER - STORE</td>
                    ...
                    <td>
                        <asp:HyperLink ID="hlVolver" runat="server" NavigateUrl="~/Administrador/PrincipalAdmin.aspx">Volver</asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2">Gestion Usuarios</td>
                    <td class="auto-style4">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
